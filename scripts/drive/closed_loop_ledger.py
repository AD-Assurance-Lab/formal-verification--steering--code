...
`python -m study.ledger` then checks against the pre-registered expectation.
    ...
    python scripts/drive/closed_loop_ledger.py --student S_mixed_84x28 --condition night --reps 10
"""
...
def drive_once(world, vehicle, cam_queue, model, device, direction, max_steps,
    ...
    for _ in range(max_steps):
        ...
        # neither driven by the policy nor scored. See scripts/training/evaluate.py for why --
...
def main():
    ...
    try:
        ...
        #
        # This check lived ONLY in scripts/training/evaluate.py, which is the sweep and gate
