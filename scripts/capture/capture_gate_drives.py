...
The gate (scripts/capture/capture_driven_gate.py) asks whether the frames a certificate was
...
capture rig, not a failure rate, and rule 3 does not apply to it.
    ...
    STUDY_MAP=Town06 python3 scripts/capture/capture_gate_drives.py
    STUDY_MAP=Town04 python3 scripts/capture/capture_gate_drives.py
"""
import argparse
import os
import subprocess
