...
from steering.drive.route import load_route, signed_cte_route, pure_pursuit_route, lap_finished
...
def drive_collect(world, vehicle, img_queue, model, device, w, h, weather, direction,
    ...
    for step in range(max_steps):
        ...
        # ODD BOUNDARY: pure pursuit bridges the intersections -- see scripts/training/dagger.py.
    ...
    try:
        ...
        for r_local in range(args.rounds):
            ...
            if r_local > 0:
                ...
                # Kill, then WAIT for the port -- see scripts/training/dagger.py. A fixed sleep
